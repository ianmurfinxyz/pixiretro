...
public:
  ...
  //
  // TODO 
  // - should init this class with the start time, i.e. lastTickNow = initial time, at min
  //   am making an assumption that initial time is 0 and thus lastTickNow can also be set
  //   to 0. But the initial game time is set independently thus if that changes this breaks.
  //
  class Metronome
  {
  public:
    ...
    void setTickPeriod(Duration_t period) {_tickPeriod += period;}   // BUG??!!!!! should be assignment I think
